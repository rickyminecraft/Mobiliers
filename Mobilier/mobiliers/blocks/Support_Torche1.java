...
//	}
	...
	public void randomDisplayTick(World world, int par2, int par3, int par4, Random par5Random)
	{
		...
		if (StorcheD.getType(Meta) == StorcheD.ALLUME)
		{
			if (Direction == StorcheD.STORCHE_X_NEG)
			{
				world.spawnParticle("smoke", d0 - d4+0.45D, d1 + d3, d2, 0.0D, 0.0D, 0.0D);
				world.spawnParticle("flame", d0 - d4+0.45D, d1 + d3, d2, 0.0D, 0.0D, 0.0D);
			}
			if (Direction == StorcheD.STORCHE_X_POS)
			{
				world.spawnParticle("smoke", d0 - d4+0.1D, d1 + d3, d2, 0.0D, 0.0D, 0.0D);
				world.spawnParticle("flame", d0 - d4+0.1D, d1 + d3, d2, 0.0D, 0.0D, 0.0D);
			}
			if (Direction == StorcheD.STORCHE_Z_NEG)
			{
				world.spawnParticle("smoke", d0 - d4+0.255D, d1 + d3, d2+0.2D, 0.0D, 0.0D, 0.0D);
				world.spawnParticle("flame", d0 - d4+0.255D, d1 + d3, d2+0.2D, 0.0D, 0.0D, 0.0D);
			}
