...
//		int type = StorcheD.getType(data);
//		switch (type)
//		{
//			case StorcheD.TYPE_1:
//				renderSupport(coverBlock, x, y, z);
//				break;
//			case StorcheD.TYPE_2:
//				renderSupport_1(coverBlock, x, y, z);
//				break;
//			case StorcheD.TYPE_3:
//				renderSupport_2(coverBlock, x, y, z);
//				break;
//			case StorcheD.TYPE_4:
//				renderSupport_3(coverBlock, x, y, z);
//		}
	}
	...
	private void renderSupport(ItemStack coverBlock, int x, int y, int z)
	{
    	...
    	boolean allume = StorcheD.getType(data) == StorcheD.ALLUME? true : false;
    	switch (rotation)
    	{
    	case StorcheD.STORCHE_X_NEG:
    		renderBlocks.setRenderBounds(0.9D, 0.2D, 0.4D, 1.0D, 0.4D, 0.6D);
